...
for (s, b) in [(1, 10), (10, 5)]:
    ...
    temp1 = [ZDiscExp(s, b, asimov_only=False, Zcriteria=Z, CLDiscbool=False)[5] for Z in Z_array]

    #Unknown background case, with dbhat/bhat=0.5
    temp2 = [ZDiscExp(s, b, 0.5*b, asimov_only=False, Zcriteria=Z, CLDiscbool=False)[5] for Z in Z_array]
...
for (s, b) in [(1, 25), (5, 5)]:
    #Calculate P(Zexcl > Z)
    #Known background case
    temp1 = [ZExclExp(s, b, asimov_only=False, Zcriteria=Z, CLExclbool=False)[5] for Z in Z_array]

    #Unknown background case, with dbhat/bhat=0.5
    temp2 = [ZExclExp(s, b, 0.5*b, asimov_only=False, Zcriteria=Z, CLExclbool=False)[5] for Z in Z_array]
